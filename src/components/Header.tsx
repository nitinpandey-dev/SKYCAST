...
export function Header({ onLocationSelect, onUseLocation, locationLoading, activeLocation }: HeaderProps) {
  ...
  return (
    <header className="w-full px-4 pt-4 sticky top-0 z-40 select-none">
      <div className="max-w-7xl mx-auto bg-header-bg backdrop-blur-lg border border-border-custom px-4 py-2.5 rounded-2xl shadow-sm transition-all duration-300 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
