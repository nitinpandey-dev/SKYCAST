        ...
        <div className="hidden md:flex items-center justify-between w-full md:w-auto gap-4 shrink-0">
          ...
          {activeLocation && (
            <div className="relative" ref={switcherRef}>
              ...
              {switcherOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white/95 dark:bg-[#07101f]/95 backdrop-blur-xl rounded-2xl shadow-xl border border-border-custom py-2.5 z-50 animate-in fade-in duration-200">
                  <button
